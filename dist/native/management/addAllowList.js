...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [players]) {
        return this.success(!!(await ctx.client.minecraft.server?.allowlist().add(players.map(parsePlayer_1.default)).catch(ctx.noop)));
    }
});
//# sourceMappingURL=addAllowList.js.map